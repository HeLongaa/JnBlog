...
![Connect Lost](https://oss.helong.online/bucket-IMG/86e258c8e03d794f774e62f5662d7efb6f7cb56d792cb1ff4b8d52c512fa2a06.png)
...
| 环境变量 | 含义 | 说明 |
| :--- | :--- | :--- |
| `DB_POSTGRESDB_DATABASE` | 指定要连接的PostgreSQL数据库的名称 | 无 |
| `DB_POSTGRESDB_HOST` | 指定PostgreSQL数据库服务器的主机名或IP地址 | 无 |
| `DB_POSTGRESDB_PORT` | 指定PostgreSQL数据库服务器的端口号 | 默认5432 |
| `DB_POSTGRESDB_USER` | 指定用于连接PostgreSQL数据库的用户名 | 无 |
| `DB_POSTGRESDB_PASSWORD` | 指定用于连接PostgreSQL数据库的密码 | 无 |
...
![使用N8N搭建的博客友情链接和RSS订阅服务](https://oss.helong.online/bucket-IMG/9028d08a6f87d905d3a8e7ab4a0727eb44aced28e68f9287ebe6bdd937154994.png)
